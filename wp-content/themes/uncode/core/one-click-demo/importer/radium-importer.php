		...
		<script type="text/javascript">
			jQuery( function ( $ ) {
				...
				$(document).on('submit', '.uncode-import-form', function(e) {
					...
					var cf7_active_text = '<?php echo ( is_plugin_active( 'contact-form-7/wp-contact-form-7.php' ) ) ? '' : esc_html__( 'Contact Form 7 (recommended)', 'uncode' ); ?>';
					var woo_active_text = '<?php echo ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) ? '' : esc_html__('WooCommerce (recommended)', 'uncode'); ?>';
					var ucore_active_text = '<?php echo ( is_plugin_active( 'uncode-core/uncode-core.php' ) ) ? '' : esc_html__('Uncode Core (required)', 'uncode'); ?>';
