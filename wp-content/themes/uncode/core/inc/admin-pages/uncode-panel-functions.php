...
function uncode_get_admin_panel_menu_pages() {
	$welcome_desc = sprintf( esc_html__( "%s is installed! Please register your purchase, make sure that you've fulfilled all of the requirements below, and look for a green success message.", "uncode" ), UNCODE_NAME );
